								...
								<div class="card card-custom">
									...
									<div class="card-body">
										...
										<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
											<thead>
												<tr>
													<th title="Field #1">Emirate ID</th>
													<th title="Field #2">Full Name</th>
													<th title="Field #3">Sale / Rent price</th>
													<th title="Field #4">Community/Property</th>
											...
											<tbody>
                                                ...
                                                <tr>
													<td>{{$offer->emirate_id ?? 'Xx-xx-xX'}}</td>
													<td>{{$offer->full_name ?? 'Xx-xx-xX'}}</td>
													<td> $ {{$offer->sale_price ?? $offer->rent_price}}</td>
													<td>{{$offer->property->name_en}}</td>
													<td>$22672.60</td>
													<td>2016-11-28</td>
